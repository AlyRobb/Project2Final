...
var actorChars = {
  "@": Player,
  "y": Star, // A coin will wobble up and down
  "o": Crown,
  "p": Portal, //This is actually a skull enemy now, but I didn't change the name.
  "=": Lava, "|": Lava, "v": Lava,
};
...
var wobbSpeed = 3, wobbDist = 0.4;
  Crown.prototype.act = function(step) {
    ...
    this.pos = this.basePos.plus(new Vector(wobbPos, wobbDist));
  };

var wubbSpeed = 2, wubbDist = 0.5;
  Portal.prototype.act = function(step) {
    this.wobble += step * wubbSpeed;
    var wubbPos = Math.sin(this.wobble) * wubbDist;
    this.pos = this.basePos.plus(new Vector(0, wubbPos));
  }
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  // Player loses
  if (type == "lava" || type == "portal" && this.status == null) {
    this.status = "lost";
    this.finishDelay = 1;
  } else if (type == "star" || type == "crown") {
